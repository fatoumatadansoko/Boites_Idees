...
<div class="container">
    ...
    <form action="{{ route('idees.update', $idee->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="libelle" name="libelle" value="{{ $idee->libelle }}" >
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description :</label>
            <textarea class="form-control" id="description" name="description" rows="3" >{{ $idee->description }}</textarea>
        </div>
        <div class="mb-3">
            <label for="auteur_nom_complet" class="form-label">Nom complet de l'auteur :</label>
            <input type="text" class="form-control" id="auteur_nom_complet" name="auteur_nom_complet" value="{{ $idee->auteur_nom_complet }}" >
        </div>
        <div class="mb-3">
            <label for="auteur_email" class="form-label">Email de l'auteur :</label>
            <input type="email" class="form-control" id="auteur_email" name="auteur_email" value="{{ $idee->auteur_email }}" >
        </div>
        <div class="mb-3">
